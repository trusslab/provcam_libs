...
# vcu-modules
git diff vcu-modules-diff..main -- vcu-modules/ > vcu-modules.patch;
...
# vcu-omx-il
git diff vcu-modules-diff..main -- vcu-omx-il/ > vcu-omx-il.patch;
...
# vcu-ctrl-sw
git diff vcu-modules-diff..main -- vcu-ctrl-sw/ > vcu-ctrl-sw.patch;
